...
const updates = [
  {
    ...
    description: 'Bewerbungsfoto mit KI erstellen kostenlos: Bereiten Sie professionelle Bewerbungsfotos online, Passfoto und Hintergrund fuer Schule und Beruf vor.',
  },
  {
    locale: 'de',
    ...
    keywords: [
      ...
      'professionelle Profile mit KI',
      'Headshot-Stile aus Selfies',
      'kreative Avatar Projekte',
    ],
  },
  {
    locale: 'de',
    ...
    keywords: [
      'Passbilder Layout zum Drucken',
      'Druck-JPG fuer Passbilder',
      'Passbilder auf A4 anordnen',
  ...
  },
  {
    ...
    keywords: [
      'cambio foto curriculum ia',
      'foto curriculum con inteligencia artificial',
      'renovar foto de curriculum',
      'foto profesional para curriculum',
    ],
  },
]
