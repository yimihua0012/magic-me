...
assert(read('src/app/api/admin/blog-post-draft/route.ts').includes('one or two localized long-tail Google search keywords'), 'DeepSeek preparation must return one or two localized long-tail Google search keywords')
