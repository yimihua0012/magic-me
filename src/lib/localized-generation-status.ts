...
const localizedStatus: Record<Locale, Record<StatusKey, string>> = {
  ...
  zh: {
    initializing: '正在初始化...',
    invalidId: '生成任务 ID 无效',
    noPhotos: '还没有上传照片',
    preparing: '正在准备参考照片...',
    failedStart: '启动生成失败',
    taskNotFound: '未找到任务，请重新开始',
    failedCheck: '检查任务状态失败',
    complete: '生成完成，请查看结果。',
    failed: '生成失败，请重试。',
    rendering: '正在生成你的职业头像...',
    finalizing: '正在整理细节并准备结果...',
    polishing: '正在优化光线、表情和头像细节...',
    renderingSelected: '正在生成你选择的头像风格...',
    matching: '正在匹配参考照片和风格...',
    analyzing: '正在分析参考照片...',
    ready: '你的职业头像已准备好！',
  },
  es: {
