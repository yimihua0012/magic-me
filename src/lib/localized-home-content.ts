...
export const localizedHomeContent: Record<Exclude<Locale, 'en'>, LocalizedHomeContent> = {
  zh: {
    ...
    howItWorksTitle: '怎么用',
    howItWorksSubtitle: '注册免费送 2 张头像,之后按需生成',
    steps: [
      { title: '注册送 2 次免费生成', text: '注册不用绑卡,白送 2 次生成机会,先出图体验。' },
      { title: '传一张好照片,挑风格', text: '上传 1 张清晰正脸照,挑个风格——换上新服装、背景和光线,形象还是你的形象。每风格扣 1 点数。' },
      { title: '生成即下载', text: '几分钟出高清图,LinkedIn、简历、资料页直接可用。' },
    ],
  ...
  es: {
    ...
    howItWorksSubtitle: 'Regístrate gratis, llévate 2 retratos y genera más cuando quieras',
    steps: [
      { title: 'Regístrate y recibe 2 gratis', text: 'Sin tarjeta. 2 retratos de regalo para empezar.' },
      { title: 'Sube una foto y elige estilo', text: 'Cada estilo trae ropa, fondo y luz nuevos, pero en la foto sigues siendo tú. Cada estilo usa 1 crédito.' },
      { title: 'Descarga y listo', text: 'Retratos en alta resolución en minutos, para LinkedIn y CV.' },
    ],
    ...
    examplesTitle: 'Estilos de retrato profesional y fotos ID',
  ...
  fr: {
    ...
    howItWorksSubtitle: 'Inscrivez-vous, profitez de 2 portraits offerts et générez-en plus',
    steps: [
      { title: '2 portraits offerts', text: 'Inscription gratuite, sans carte bancaire.' },
      { title: 'Importez une photo, choisissez un style', text: 'Chaque style apporte vêtements, fond et lumière nouveaux, mais c\u2018est bien vous sur la photo. Chaque style utilise 1 crédit.' },
      { title: 'Téléchargez', text: 'Vos portraits haute résolution en quelques minutes, pour LinkedIn et CV.' },
    ],
    ...
    examplesTitle: 'Styles de portrait professionnels et photos ID',
  ...
  de: {
    ...
    howItWorksSubtitle: 'Kostenlos anmelden, 2 Headshots gratis, jederzeit mehr erstellen',
    steps: [
      { title: '2 Headshots gratis', text: 'Registrierung kostenlos, ohne Kreditkarte.' },
      { title: 'Foto hochladen, Look wählen', text: 'Jeder Stil bringt Kleidung, Hintergrund und Licht neu, aber du bist es, der auf dem Bild bleibt. Jeder Stil kostet 1 Credit.' },
      { title: 'Herunterladen', text: 'Headshots in hoher Auflösung in Minuten, für LinkedIn und Lebenslauf.' },
    ],
    ...
    examplesTitle: 'Professionelle Headshots und Ausweis-Fotos',
  ...
  ja: {
    ...
    howItWorksTitle: '使い方',
    howItWorksSubtitle: '無料登録で2回分をゲット、あとは好きな時に追加',
    steps: [
      { title: '登録で2回分無料', text: 'クレジットカード不要。まず2回分を無料で試せます。' },
      { title: '写真を1枚アップしてスタイルを選ぶ', text: '新しい服・背景・光に変わっても、写真に写っているのはあなた自身。各スタイルは1クレジット。' },
      { title: 'ダウンロード', text: '高画質で数分完成。LinkedInや履歴書にすぐ使えます。' },
    ],
    ...
    examplesTitle: 'プロフェッショナルなヘッドショットと証明写真',
