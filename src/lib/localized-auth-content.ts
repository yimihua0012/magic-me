...
export const localizedAuthContent: Record<Locale, AuthContent> = {
  ...
  zh: {
    signInTitle: '欢迎回来',
    registerTitle: '创建账户',
    signInSubtitle: '登录后生成你的 AI 职业形象照',
    registerSubtitle: '今天开始创建自然可信的职业头像',
    google: '使用 Google 继续',
    x: '使用 X 继续',
    divider: '或',
    fullName: '姓名',
    ...
    privacyJoin: '和',
    privacy: '隐私政策',
    errorDefault: '第三方登录失败，请重试。',
    errorMissingCode: '第三方登录没有返回授权码，请重试。',
    errorExchangeFailed: '无法完成第三方登录，请检查授权回调地址。',
    errorSessionMissing: '登录已完成，但会话没有保存，请重试。',
  },
  es: {
