...
export const localizedDashboardContent: Record<Locale, DashboardContent> = {
  ...
  zh: {
    ...en,
    title: '你的职业头像',
    subtitle: '管理和下载 AI 生成的职业形象照',
    newGeneration: '新建生成',
    creditStatus: '点数状态',
    creditsReady: '{credits} 个点数可用',
    noActiveCredits: '暂无可用点数',
    creditDescription: '上传照片、选择风格，然后按选择扣除点数生成。',
    status: '状态',
    imagesAvailable: '{credits} 张图片可用',
    needCredits: '需要点数',
    expires: '到期',
    noActivePackage: '暂无有效点数包',
    dayLeft: '天剩余',
    daysLeft: '天剩余',
    generationDisabled: '点数恢复前暂不能生成。',
    noHeadshotsTitle: '还没有头像',
    noHeadshotsText: '上传一张自拍，让 AI 在几分钟内为你生成职业头像。',
    generateFirst: '生成第一组头像',
    processing: '处理中...',
    completed: '已完成',
    failed: '失败',
    styles: '个风格',
    viewAll: '查看全部头像',
    viewDetails: '查看详情',
    deleteConfirm: '确定要删除这次生成记录吗？',
    deleteFailed: '删除生成记录失败，请重试。',
    createNew: '创建新任务',
  },
  es: {
    ...en,
