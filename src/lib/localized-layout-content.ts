...
Object.assign(localizedLayoutContent, {
  es: {
    ...
    footer: {
      ...localizedLayoutContent.es.footer,
      tagline: 'Retratos IA para perfiles profesionales, marca personal, equipos y proyectos creativos.',
      product: 'Producto',
      features: 'Funciones',
      pricing: 'Precios',
      generate: 'Crear retratos',
  ...
  de: {
    ...
    footer: {
      ...localizedLayoutContent.de.footer,
      tagline: 'KI-Portrats fuer berufliche Profile, Personal Branding, Teams und kreative Projekte.',
      product: 'Produkt',
      features: 'Funktionen',
      pricing: 'Preise',
      generate: 'Portrats erstellen',
  ...
  ja: {
    ...
    footer: {
      ...localizedLayoutContent.ja.footer,
      tagline: '仕事用プロフィール、個人ブランディング、チーム紹介、創作向けに使えるAIポートレート。',
      product: 'プロダクト',
      features: '機能',
      pricing: '料金',
      generate: '写真を作成',
...
} satisfies Partial<Record<Locale, LocalizedLayoutContent>>)
