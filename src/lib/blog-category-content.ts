...
const categoryContentByLocale: Record<Locale, (label: string, count: number) => Omit<BlogCategorySeoContent, 'keywords'>> = {
  en: (label, count) => ({
    ...
    workflowHeading: 'Generate professional headshots',
    workflowDescription: `Use the ${label} guidance to choose a realistic professional headshot direction, then generate polished images for LinkedIn, resumes, business profiles, team pages, or public bios.`,
    workflowLink: 'Generate professional headshots',
