...
const pageText: Record<Locale, {
  ...
  zh: {
    eyebrow: 'Free Photo Tools',
    title: '免费在线 Photo Tools',
    description: '在线处理去背景、证件照裁剪、图片尺寸调整、常用比例裁剪、形状裁剪和打印排版。',
    navLabel: 'Photo Tools',
    freeIdTool: 'Free ID Photo Tool',
    combinedText: '需要原来的证件照裁剪、换底和打印排版组合流程？',
    combinedLink: '打开 Free ID Photo Tool',
    faq: 'FAQ',
    professionalOutfit: '职业服装照片',
    professionalImage: '职业形象照片',
    cropSourceDescription: '上传本地 JPG、PNG 或 WebP 图片，选择证件照尺寸，调整裁剪位置并下载 JPG。',
    cropUploadLabel: '上传本地图片',
    cropEmptyText: '上传本地图片后开始裁剪。',
  },
  es: {
    eyebrow: 'Photo Tools',
