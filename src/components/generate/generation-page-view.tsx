...
const generationContent: Record<Locale, GenerationPageContent> = {
  ...
  zh: {
    ...
    completedTitle: '你的职业头像已生成！',
    processingTitle: '正在生成职业头像',
    completedSubtitle: '查看并下载你喜欢的职业形象照',
    processingSubtitle: '通常需要约 3 分钟',
    creating: '正在为你生成 {count} 张头像',
    failedTitle: '生成遇到问题',
    tryAgain: '重试',
    goHome: '返回首页',
    deselectAll: '取消全选',
    ...
    loveTitle: '还想生成更多风格？',
    loveText: '购买 Pro 点数后，可以继续生成更多适合不同用途的头像。',
    buyPro: '购买 {planName} 点数 - {price}',
    createNew: '创建新的头像生成任务',
    backHome: '返回首页',
    completionTitle: '生成完成',
    completionReady: '你选择的头像已经准备好。',
    completionText: '确认后即可查看、选择和下载结果。',
    viewHeadshots: '查看头像',
    download: '下载',
    select: '选择',
    deselect: '取消选择',
