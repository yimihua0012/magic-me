...
const workflowLinks = [
  {
    ...
    description: 'Review original photos and generated professional portraits before choosing a style.',
  },
  {
    href: '/questions',
    title: 'Read AI headshot questions',
    description: 'Check upload tips, commercial use, credit validity, and realistic likeness guidance.',
  },
  {
    href: '/pricing',
    title: 'View credit packs',
    description: 'Choose one-time credits for LinkedIn headshots, resume photos, and business portraits.',
  },
]
