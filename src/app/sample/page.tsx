...
export const metadata: Metadata = {
  ...
  description:
    'See six AI headshot sample comparisons with original photos and generated results for LinkedIn, resumes, business portraits, and professional profile photos.',
  keywords: [
